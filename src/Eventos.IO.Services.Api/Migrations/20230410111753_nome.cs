...
namespace Eventos.IO.Services.Api.Migrations
{
    public partial class nome : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventoViewModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventoViewModel_CategoriaViewModel_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "CategoriaViewModel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventoViewModel_EnderecoViewModel_EnderecoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventoViewModel_CategoriaId",
                table: "EventoViewModel",
                column: "CategoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_EventoViewModel_EnderecoId",
                table: "EventoViewModel",
                column: "EnderecoId");
        }
