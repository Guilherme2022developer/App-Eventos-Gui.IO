...
namespace Eventos.IO.Site.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            ILogger<RegisterModel> logger, IDomainNotificationHandler<DomainNotification> notifications, IOrganizadorAppService organizadorAppService,
        ...
        public class InputModel
        {
            ...
            [Required(ErrorMessage = "A data de nascimento é requirida")]
